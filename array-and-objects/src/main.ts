...
let test = []
let bands: string[] = [] // This i empty array with declaring it is string
bands.push('string')

// Tuple
let myTuple: [string, number, boolean] = ['jigar', 2002, true]
...
interface Guitarist {
    name?: string,
    active: boolean,// with out ? it will show an error and with ? it will show undefine
